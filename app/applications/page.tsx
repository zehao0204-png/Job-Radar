    ...
    <main className="min-h-screen bg-[#f6f7f9] text-[#19202e]">
      <header className="border-b border-[#e8ebf0] bg-white">
        <div className="mx-auto flex h-16 max-w-[1440px] items-center justify-between px-5 lg:px-8">
          ...
          <nav className="hidden items-center gap-8 text-sm text-[#687083] md:flex"><Link href="/">招聘情报</Link><span className="font-semibold text-[#242a36]">我的投递</span><span>提醒中心</span></nav>
